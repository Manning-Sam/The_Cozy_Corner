...
class Config():
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('postgres://gaadfbyo:XVgb1WKrsX1yPbML0l9u6gr4TgjPefOu@ruby.db.elephantsql.com/gaadfbyo') or 'sqlite:///' + os.path.join(basedir, 'app.db')
